...
import { createChallengeController, getSocialId, newSocialLinkController, tokenController, verifyController } from './rola.js';
...
export const redisConfig = Redis.configFromEnv(process.env);
export const redisClient = Redis.createClient(redisConfig, logger);
export const pgPool = Database.getPool(Database.configFromEnv(process.env, environment));
