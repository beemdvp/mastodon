...
Rails.application.config.content_security_policy do |p|
  ...
  if Rails.env.development?
    ...
    p.connect_src :self, :data, :blob, *media_hosts, Rails.configuration.x.streaming_api_base_url, *front_end_build_urls, "localhost:4000 *.radixdlt.com"
    p.script_src  :self, :unsafe_inline, :unsafe_eval, assets_host, "localhost:4000 *.radixdlt.com"
...
Rails.application.reloader.to_prepare do
  PgHero::HomeController.content_security_policy do |p|
    p.script_src :self, :unsafe_inline, assets_host, "*.radixdlt.com radixdlt.com"
    p.style_src  :self, :unsafe_inline, assets_host, "*.radixdlt.com radixdlt.com"
  end
